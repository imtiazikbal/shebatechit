    ...
    <div class="max-w-3xl">
        ...
        >
            ...
            <div class="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-1.5">Cover Image URL <span class="normal-case font-normal">(optional)</span></label>
                    <input type="url" name="image_url" value="{{ old('image_url', $blog->image_url) }}"
                        class="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-900 text-sm focus:outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 transition-all"
                        placeholder="https://…">
                </div>
